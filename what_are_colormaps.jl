...
begin
	...
	heatmap(cPatch, 
		xticks=:none,
		yticks=:none, title="RGB = $([redM, greenM, blueM])")
...
heatmap(r, xticks=:none, yticks=:none)
...
md"""$(@bind greyMult Slider(0:0.1:1, default = 0.7, show_value=true)) """
...
# ╔═╡ 81adabb0-058c-11eb-3ee6-959bbf5f0c5d
 begin
	...
	heatmap(rgb, xticks=:none, yticks=:none, title="RGB = $(repeat([greyMult],1,3))")
end
...
begin
	...
	heatmap(allColors2d, xticks=:none, yticks=:none)
end
...
@bind the_color Select(color_names);
...
begin
	...
	plot!(data[xLoc,yLoc,zLoc,:], 1:size(data,4) ,subplot=2)
...
git-tree-sha1 = "4a4e68e9165b047c97480db1bda9601ff2ac24af"
...
git-tree-sha1 = "248e89ea4b24e09b97c282d7b0257a8596784f46"
