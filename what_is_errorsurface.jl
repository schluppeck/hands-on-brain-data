...
# ╔═╡ b99d7468-04f0-435b-a83e-34c96f25af73
using Images
...
begin
	...
	liney = 3.2 .* linex + 1.8 .* randn(size(linex))
end

# ╔═╡ 2be2e67c-a499-460c-a9b0-93c6c6aae924
md""" setting the weight W $(@bind W  Slider(0:0.1:5; default=0.5, show_value = true)) """
...
begin
	...
	p1 = plot(linex, liney;  seriestype = :scatter, ms = 8, 
		color="red", label="", size=(300,300), xlims= (minx, maxx), ylims = (0,40),
		xlabel="x", ylabel="some y")
	#yaxis!(p1, limits = (0, 5))
	plot!(p1, thex, they)
	p2 = plot(0:.1:5, [sum( (liney .- b.*linex).^2 ) for b in 0:.1:5 ], color="black")
	plot!([W], [SSE];  seriestype = :scatter, ms = 8, 
		color="red", label="", size=(300,300), xlims = (-5, 5), ylims = (0, 3000),
...
julia_version = "1.9.1"
manifest_format = "2.0"
project_hash = "05c1858a64d2e7a851b49679e559046297eeebef"
