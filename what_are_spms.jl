...
# ╔═╡ f60147aa-3667-4e8f-b1a4-d4f57c0297b2
begin
  import Pkg
  Pkg.activate(".")
  md"Loading prepared packages"
end
...
md""" d.o.f. $(@bind deg_freedom Slider(2:1:200; default=5, show_value=true)) """
...
begin
	...
	plot(Distributions.TDist(deg_freedom), fill=(0, .5,:teal), 
		 xlims=(-10,10), 
		 size=(600,200), title="t Distribution (ν=$(deg_freedom))", label=false, layout=1)
end
