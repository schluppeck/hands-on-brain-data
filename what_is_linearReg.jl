...
md"""# How do we analyze data here? """
...
md"""
**weight:** $(@bind weight Slider(range(1, 3, step=0.5), default=1, show_value=true))
"""
...
# ╔═╡ 94089440-fa89-11ea-0d15-89f2e55a39be
begin
	plotWithBeta(d[:,1], d[:,5], d[:,3], m)
	#savefig("test.pdf")
end
...
begin
	t = 0:1:(nPoints-1);
	y = weight .* t;
	#plot(t,y, color=:red, label=:none)
	plot(t,y, seriestype=:scatter, marker=:square, ms=5, 
		label=:none, 
		aspect_ratio=1, 
